...
appearance makes users often unknowningly choose hy-\linebreak% !!!!!!!!! IMPORTANT !!!!!!!!!
phens instead.

\textbf{Typographic quotes:} A~final common typographic annoyance is using the wrong type of double quotes.
Keyboards only have one symbol for both a~beginning and an end quote, namely \Verb!"!.
Commonly named a~typewriter or programmer's quote, it does not indicate to which part of the quotation it belongs.
